...
import { useUser } from './contexts/authentication/userContext.jsx'; 
    ...
    <div className="profile-page-container">
      <div className="profile-content">
        <div className="profile-details">
          ...
          <button onClick={handleQuit} className="quit-btn">Sign Out</button>
          <button onClick={todoapp} className="todo-btn">To Do App</button>
        </div>
